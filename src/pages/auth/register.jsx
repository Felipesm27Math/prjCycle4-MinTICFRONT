    ...
    <div className='flex flex-col h-full w-full items-center justify-center'>
      ...
      <form className='flex flex-col' onSubmit={submitForm} onChange={updateFormData} ref={form}>
        <div className='grid grid-cols-2 gap-5'>
          ...
          <Input label='Contraseña:' name='contrasena' type='password' required />
        </div>
        <ButtonLoading
      ...
      <span>Al registrarse estas aceptando nuestras políticas de privacidad. ¿Ya tienes una cuenta?</span>
      <Link to='/auth/login'>
