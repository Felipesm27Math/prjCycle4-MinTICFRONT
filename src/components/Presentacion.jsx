...
const Presentacion = () => {
  return (
      <div className="contenedorPresentacion">
        ...
        <div>
          <p className="parrafo">
            Modelo de sistema de información que soporta la gestión de proyectos
            de investigación. Desarrollado en el ciclo 4 de la MisiónTic 2021
            por el equipo NAFC-Code.
          </p>
